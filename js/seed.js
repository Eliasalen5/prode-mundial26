function isFeatured(i) {
  // F1: BRA-MAR(6) ARG-ALG(19) ENG-CRO(22) | F2: MEX-KOR(28) NED-SWE(33) ARG-AUT(41) | F3: GER-ECU(56) ESP-URU(64) POR-COL(69) ARG-JOR(72)
  return [6, 19, 22, 28, 33, 41, 56, 64, 69, 72].includes(i);
}
...
function getSeedData() {
  ...
  // 16vos (R32) — Jun 29–Jul 2
  addKO('R32','06-29','13:00','1A','2B');
  addKO('R32','06-29','16:00','1C','2D');
  addKO('R32','06-29','19:00','1E','2F');
  addKO('R32','06-29','22:00','1G','2H');
  addKO('R32','06-30','13:00','1I','2J');
  addKO('R32','06-30','16:00','1K','2L');
  addKO('R32','06-30','19:00','1B','2A');
  addKO('R32','06-30','22:00','1D','2C');
  addKO('R32','07-01','13:00','1F','2E');
  addKO('R32','07-01','16:00','1H','2G');
  addKO('R32','07-01','19:00','1J','2I');
  addKO('R32','07-01','22:00','1L','2K');
  addKO('R32','07-02','13:00','3A','3B');
  addKO('R32','07-02','16:00','3C','3D');
  addKO('R32','07-02','19:00','3E','3F');
  addKO('R32','07-02','22:00','3G','3H');

  // 8vos (R16) — Jul 4–7
  addKO('R16','07-04','13:00','W49','W50');
  addKO('R16','07-04','16:00','W51','W52');
  addKO('R16','07-04','19:00','W53','W54');
  addKO('R16','07-04','22:00','W55','W56');
  addKO('R16','07-05','13:00','W57','W58');
  addKO('R16','07-05','16:00','W59','W60');
  addKO('R16','07-05','19:00','W61','W62');
  addKO('R16','07-05','22:00','W63','W64');

  // 4tos (QF) — Jul 9–10
  addKO('QF','07-09','13:00','W65','W66');
  addKO('QF','07-09','17:00','W67','W68');
  addKO('QF','07-10','13:00','W69','W70');
  addKO('QF','07-10','17:00','W71','W72');

  // Semis (SF) — Jul 14–15
  addKO('SF','07-14','15:00','W73','W74');
  addKO('SF','07-15','15:00','W75','W76');

  // 3er puesto — Jul 18
  addKO('3rd','07-18','15:00','L77','L78');
