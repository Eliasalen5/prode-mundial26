...
function buildHome() {
  ...
  html += `<div class="info-banner">
    ...
    ⚽ Partidos comunes (<span class="highlight">$500</span>):<br>
    &nbsp;&nbsp;• Resultado exacto: <strong>3 pts</strong><br>
    &nbsp;&nbsp;• Solo ganador: <strong>1 pt</strong><br>
    🔥 Partidos <strong>Destacados</strong> (<span class="highlight">$1.000</span>):<br>
    &nbsp;&nbsp;• Resultado exacto: <strong>5 pts</strong><br>
    &nbsp;&nbsp;• Solo ganador: <strong>2 pts</strong><br>
